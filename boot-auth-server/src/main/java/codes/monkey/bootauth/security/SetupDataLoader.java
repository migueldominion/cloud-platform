...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
    	/*
    	 * Note how we’re using an alreadySetup flag to determine if the setup needs to run or not. This is simply because, 
    	 * depending on how many contexts you have configured in your application – the ContextRefreshedEvent may be fired multiple times. 
    	 * And we only want the setup to be executed once.
    	 */
        if (alreadySetup) {
            return;
        }
        ...
        createRoleIfNotFound("ROLE_READER", userPrivileges);
